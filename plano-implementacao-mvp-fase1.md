...
| **M4 — Busca básica** 🔄         | Embeddings locais multilíngues via fastembed (carga inicial); busca híbrida no Streamlit: tema → resultados ranqueados com fonte                                              | Código implementado e validado (busca "Cerrado" retorna as 3 seções ranqueadas já com índice parcial); **carga inicial dos 13,2 mil vetores em execução** (12% no commit — rotina retomável). Critério A1 fecha quando a carga completar. Decisões §12.3                                                                                                             | \~2 semanas     |
